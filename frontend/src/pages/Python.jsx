...
const Python = () => {
  ...
  return (
    <>
      <Helmet>
        <title>Python Programming - FlixerLearn</title>
        <meta
          name="description"
        ...
        <meta
          name="keywords"
          content="Python, FlixerLearn, Python Tutorials, Visual Python, Python Theory, Python Interviews"
        />
      ...
      <div className="min-h-screen w-full bg-[#0b0320] text-white px-10 py-10">
          ...
          <div className="lg:col-span-2 relative rounded-2xl overflow-hidden shadow-xl border border-white/10
            ...
            <div className="absolute inset-0 p-10 flex flex-col justify-center bg-black/40">
              ...
              <div className="flex space-x-4">
                {/* <button className="bg-linear-to-r from-yellow-500 to-yellow-600 px-6 py-3 rounded-lg shadow-lg">
                  Preview
                </button>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-linear-to-br from-blue-400/60 to-blue-600/60 
                          backdrop-blur-md border border-white/20 shadow-xl">
          ...
          <div className="p-6 rounded-2xl bg-linear-to-br from-violet-400/60 to-violet-600/60 
                          backdrop-blur-md border border-white/20 shadow-xl">
            <h2 className="text-xl font-bold mb-1 text-white drop-shadow">Python Bot Service</h2>
            <p className="text-sm text-white/90 mb-4">
              Dive into Python with interactive chatbot.
            </p>
            <button
