...
const ArVr = () => {
  ...
  return (
    <>
      ...
      <Helmet>
        <title>AR/VR Development | FlixerLearn</title>
        <meta name="description" content="Explore immersive AR/VR learning with interactive simulations and interview preparation." />
        <meta name="keywords" content="AR, VR, development, immersive learning, interview questions, flixerlearn" />
        <meta name="robots" content="index, follow" />
        <link rel="canonical" href="https://elearning-platform-zksp.vercel.app/ar-vr" />
      </Helmet>
      ...
      <div className="min-h-screen w-full bg-[#0b0320] text-white px-10 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-linear-to-br from-green-300/60 to-green-500/60 
                          backdrop-blur-md border border-white/20 shadow-xl">
