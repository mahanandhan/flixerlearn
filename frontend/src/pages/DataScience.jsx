...
//       <Helmet>
//         <title>Data Science - FlixerLearn</title>
//         <meta
//           name="description"
//           content="Master Data Science with FlixerLearn. Dive into visualizations, theory, and real-world interview preparation tailored for aspiring data scientists."
//         />
//         <meta
//           name="keywords"
//           content="Data Science, FlixerLearn, Data Visualization, Machine Learning, Data Science Interviews, Data Science Theory, DS Tutorials"
//         />
    ...
    <>
      ...
      <div className="min-h-screen w-full bg-[#0b0320] text-white px-10 py-10">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
          ...
          <div className="p-6 rounded-2xl bg-linear-to-br from-lime-400/60 to-green-500/60 
                          backdrop-blur-md border border-white/20 shadow-xl">
