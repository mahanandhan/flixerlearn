...
import datasetJson from "../dataset/cybersecurity.json";

const ITEMS_PER_PAGE = 5;

const Cybersecuritybot = () => {
  const [input, setInput] = useState("");
  const [chatHistory, setChatHistory] = useState([
    {
      sender: "bot",
      text: "Ask a question about Cyber Security. Type 'help' to see topics."
    }
  ]);
  ...
  const handleAsk = () => {
    ...
    if (question === "help") {
      ...
      addMessage(
        "bot",
        "Here are all available Cyber Security concepts. Click a topic button to view the concept."
      );
    } else if (helpMode) {
      ...
      <header className="flex h-16 items-center justify-between border-b border-slate-900 bg-slate-900/90 px-4 md:px-8 backdrop-blur-2xl">
        <div className="flex items-center gap-3">
          ...
          <span className="text-base font-bold md:text-lg">
            FlixerLearn Cyber Security Bot
          </span>
        </div>
        ...
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
          <div>
            ...
            <h1 className="mt-3 text-2xl font-extrabold tracking-tight md:text-3xl">
              Cyber Security Bot Support Tool
            </h1>
            ...
            <p className="mt-2 text-sm text-red-400 md:text-base">
              This bot explains core cyber security concepts like CIA triad,
              malware, encryption, and secure coding from the cybersecurity
              dataset.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-xs text-slate-400 md:text-sm">
                Ask about threats, defenses, web security, and best practices.
              </div>
            </div>
          </div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    {msg.text}
                    {msg.text.includes(
                      "Here are all available Cyber Security concepts"
                    ) && renderHelpPage()}
                  </div>
                </div>
              );
          ...
          <div className="mt-4 flex items-center gap-3 border-t border-indigo-800/70 pt-3">
            <div className="flex flex-1 items-center gap-2 rounded-full border border-cyan-400 bg-[radial-gradient(circle_at_0_0,rgba(56,189,248,0.25),rgba(15,23,42,0.95))] px-4 py-2">
              <input
                ...
                placeholder="Type your Cyber Security question..."
