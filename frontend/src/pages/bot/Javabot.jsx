...
import datasetJson from "../dataset/java.json";
...
const Javabot = () => {
  ...
  const [chatHistory, setChatHistory] = useState([
    { sender: "bot", text: "Ask a question about Java. Type 'help' to see topics." }
  ]);
  ...
  const handleAsk = () => {
    ...
    if (question === "help") {
      ...
      addMessage(
        "bot",
        "Here are all available Java concepts. Click a topic button to view the concept."
      );
    } else if (helpMode) {
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-xs text-slate-400 md:text-sm">
                Ask anything about your Core Java syllabus.
              </div>
            </div>
          </div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    {msg.text}
                    {msg.text.includes(
                      "Here are all available Java concepts"
                    ) && renderHelpPage()}
                  </div>
                </div>
              );
