...
import datasetJson from "../dataset/aiml.json";
...
const AiMlbot = () => {
  ...
  const [chatHistory, setChatHistory] = useState([
    {
      sender: "bot",
      text: "Ask a question about AI & ML. Type 'help' to see topics."
    }
  ]);
  ...
  const handleAsk = () => {
    ...
    if (question === "help") {
      ...
      addMessage(
        "bot",
        "Here are all available AI & ML concepts. Click a topic button to view the concept."
      );
    } else if (helpMode) {
        ...
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-2 text-sm text-red-400 md:text-base">
              The AI & ML bot is in early development. It currently answers
              basic conceptual questions from the AIML dataset.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-xs text-slate-400 md:text-sm">
                Ask anything about core Artificial Intelligence and
              ...
              return (
                ...
                >
                  ...
                  >
                    {msg.text}
                    {msg.text.includes(
                      "Here are all available AI & ML concepts"
                    ) && renderHelpPage()}
                  </div>
                </div>
              );
