...
import datasetJson from "../dataset/arvr.json";
...
const ArVrbot = () => {
  ...
  const [chatHistory, setChatHistory] = useState([
    {
      sender: "bot",
      text: "Ask a question about AR/VR. Type 'help' to see topics."
    }
  ]);
  ...
  const handleAsk = () => {
    ...
    if (question === "help") {
      ...
      addMessage(
        "bot",
        "Here are all available AR/VR concepts. Click a topic button to view the concept."
      );
    } else if (helpMode) {
        ...
        <div className="flex flex-col justify-between gap-6 md:flex-row md:items-center">
          <div>
            ...
            <p className="mt-2 text-sm text-red-400 md:text-base">
              The AR/VR bot currently answers conceptual questions about
              augmented and virtual reality from the ARVR dataset.
            </p>
          </div>
          ...
          <div className="flex items-center gap-4">
            ...
            <div>
              ...
              <div className="text-xs text-slate-400 md:text-sm">
                Ask about concepts like tracking, SLAM, XR, UX, and more.
              </div>
            </div>
          </div>
        </div>
              ...
              return (
                ...
                >
                  ...
                  >
                    {msg.text}
                    {msg.text.includes(
                      "Here are all available AR/VR concepts"
                    ) && renderHelpPage()}
                  </div>
                </div>
              );
          ...
          <div className="mt-4 flex items-center gap-3 border-t border-indigo-800/70 pt-3">
            <div className="flex flex-1 items-center gap-2 rounded-full border border-cyan-400 bg-[radial-gradient(circle_at_0_0,rgba(56,189,248,0.25),rgba(15,23,42,0.95))] px-4 py-2">
              <input
                ...
                placeholder="Type your AR/VR question..."
